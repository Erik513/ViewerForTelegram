...
public static class Loc
{
    ...
    private static readonly Dictionary<string, string> English = new()
    {
        ...
        ["status.checkingNew"] = "Checking for new audios …",
        ["status.loadingProgress"] = "Loading … {0} / {1} audios",
        ["status.loadingCount"] = "Loading … {0} audios",
        ["status.loadingFinished"] = "Loading … finished, {0} audios",
        ["status.noAudioRange"] = "No audio in this time range.",
        ["status.notSignedIn"] = "Not signed in – open Settings.",
        ["status.count"] = "{0} audios",
        ["status.filtered"] = "{0} of {1} audios",
        ...
        ["status.credentialsDeleted"] = "Credentials deleted.",
        ...
        ["settings.sec.credentials"] = "Credentials",
        ...
        ["settings.row.reset"] = "Reset",
        ["settings.lang.tip"] = "Language of the app. Applies immediately.",
        ...
        ["settings.msg.wipe.body"] = "Really delete api_id, api_hash and phone number and sign out?",
        ["settings.msg.wipe.title"] = "Delete credentials",
    ...
    private static readonly Dictionary<string, string> German = new()
    {
        ...
        ["status.loading"] = "Lade …",
        ["status.checkingNew"] = "Suche nach neuen Audios …",
        ["status.loadingProgress"] = "Lade … {0} / {1} Audios",
        ["status.loadingCount"] = "Lade … {0} Audios",
        ["status.loadingFinished"] = "Laden … fertig, {0} Audios",
        ["status.noAudioRange"] = "Keine Audios in diesem Zeitraum.",
        ["status.notSignedIn"] = "Nicht angemeldet – Einstellungen öffnen.",
        ["status.count"] = "{0} Audios",
        ["status.filtered"] = "{0} von {1} Audios",
        ...
        ["status.credentialsDeleted"] = "Zugangsdaten gelöscht.",
        ...
        ["settings.sec.downloads"] = "Downloads",
        ["settings.sec.cache"] = "Cache",
        ["settings.sec.credentials"] = "Zugangsdaten",
        ["settings.row.language"] = "Sprache",
        ["settings.row.phone"] = "Telefon",
        ["settings.row.status"] = "Status",
        ["settings.row.folder"] = "Ordner",
        ["settings.row.used"] = "Belegt",
        ["settings.row.reset"] = "Zurücksetzen",
        ["settings.lang.tip"] = "Sprache der App. Wird sofort übernommen.",
        ...
        ["settings.msg.wipe.body"] = "api_id, api_hash und Telefonnummer wirklich löschen und abmelden?",
        ["settings.msg.wipe.title"] = "Zugangsdaten löschen",
